...
var cornerstoneTools = (function ($, cornerstone, cornerstoneTools) {
    ...
    function touchDragCallback(e,eventData)
    {
        ...
        cornerstone.setViewport(dragData.element, dragData.viewport);
     	$("#bottomleft").html("<span style='color:yellow'>WW/WC:"+Math.round(dragData.viewport.voi.windowWidth) + "/" + Math.round(dragData.viewport.voi.windowCenter)+"</span>");  		   
...
var cornerstoneTools = (function ($, cornerstone, cornerstoneTools) {
    ...
    function zoomTouchDrag(e, eventData)
    {
        ...
        cornerstone.setViewport(dragData.element, dragData.viewport);
     	$("#bottomright").html("<span style='color:yellow'>Zoom:"+changeTwoDecimal_f(dragData.viewport.scale)+"</span>");               
