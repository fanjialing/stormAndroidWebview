...
(function (root, factory) {
	...
	// json header deal with
	function parseJson(byteArray){
        ...
        function readPrefix()
        {
        	console.log(" parseJson readPrefix()");
            byteStream.seek(128);
        	console.log(byteStream.position);
        	return;
        ...
        function readPart10Header()
        {
        	...
        	console.log("parseJson readPart10Header");
			readPrefix();
        ...
        function isExplicit(metaHeaderDataSet) {
        	console.log("parseJson isExplicit");
        ...
        {
        	console.log("parseJson mergeDataSets");
        ...
        {
        	console.log("parseJson readDataSet");
        ...
        function parseTheByteStream() {
        	console.log("parseJson parseTheByteStream");
     ...
     */
     function parseDicom(byteArray,flag) {
		console.log("parseDicom");
        if(byteArray === undefined)
        {
            throw "dicomParser.parseDicom: missing required parameter 'byteArray'";
        }
        ...
        // main function here
        function parseTheByteStream() {
        	console.log("parseTheByteStream");
            var metaHeaderDataSet = readPart10Header();
            var dataSet = readDataSet(metaHeaderDataSet);
            dataSet.warnings = byteStream.warnings;
            return mergeDataSets(metaHeaderDataSet, dataSet);
    ...
    if(dicomParser === undefined) {
        ...
        // json global var case
        dicomParser.parseJson = parseJson;
        return dicomParser;
    }
}));
/**
...
var dicomParser = (function (dicomParser)
{
    ...
    dicomParser.parseDicomDataSetExplicit = function (byteStream, maxPosition) {
        ...
        if(byteStream === undefined)
        {
            throw "dicomParser.: missing required parameter 'byteStream'";
        }
        ...
        //console.log(byteStream.position+"::"+maxPosition);
