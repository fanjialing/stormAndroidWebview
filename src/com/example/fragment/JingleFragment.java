...
public class JingleFragment extends BaseFragment implements OnClickListener,CordovaInterface {

	private static final String TAG = "JingleFragment";
	...
	public static JingleFragment newInstance() {
		JingleFragment settingFragment = new JingleFragment();
